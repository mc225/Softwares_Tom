...
function [XOtf,YOtf,fRel]=calcOtfGridFromSampleFrequencies(sampleFrequencies,gridSize,cutOffSpatialFrequency)
    logMessage('Using obsolute function calcOtfGridFromSampleFrequencies.m. This will break in future releases. Please inform Tom Vettenburg tv2@st-andrews.ac.uk ');
