...
classdef OrcaFlash4Cam < Cam
    ...
    methods
        ...
        function cam=set.regionOfInterest(cam,newROI)
            ...
            newROI=[cam.hardWareRegionOfInterestStepSize.*floor(newROI(1:2)./cam.hardWareRegionOfInterestStepSize) cam.hardWareRegionOfInterestStepSize.*ceil(floor(newROI(3:4)./cam.hardWareRegionOfInterestStepSize))];
